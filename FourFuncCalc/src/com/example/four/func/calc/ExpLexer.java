...
public class ExpLexer extends Lexer {
    ...
    public final void mNumber() throws RecognitionException {
        try {
            int _type = Number;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/Exp.g:27:5: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
            // src/Exp.g:27:10: ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
            {
            // src/Exp.g:27:10: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
    ...
    public void mTokens() throws RecognitionException {
        // src/Exp.g:1:8: ( T__6 | T__7 | T__8 | T__9 | T__10 | T__11 | Number | WS )
        int alt4=8;
        switch ( input.LA(1) ) {
        case '+':
            {
